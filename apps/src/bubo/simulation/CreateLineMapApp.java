 ...
 * @author Peter Abeles
 */
public class CreateLineMapApp extends LineMapDisplay
	...
	public void keyPressed(KeyEvent e) {
		if( e.getKeyChar() == 's' || e.getKeyChar() == 'S') {
			System.out.println("saving map to map.csv");
			SwingUtilities.invokeLater(new Runnable() {
				@Override
				public void run() {
					MapIO.save(getMap(), "map.csv");
				}
			});
		}
	}
