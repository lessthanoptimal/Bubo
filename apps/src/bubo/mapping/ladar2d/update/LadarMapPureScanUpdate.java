...
//                scanMatching.process(null);
			scanMatching.process(new Se2_F64());
			deltaMotion = scanMatching.getMotion();

			System.out.printf(" error %6.2e Found( %7.4f %7.4f %7.4f )\n",scanMatching.getError(),
					deltaMotion.getX(),deltaMotion.getY(),deltaMotion.getYaw());

			scanMatching.setMatchToReference();
		}


//		if( deltaMotion.getTranslation().norm() > 0.05 ) {
//			System.out.println("LARGE JUMP");
//			return;
//		}
